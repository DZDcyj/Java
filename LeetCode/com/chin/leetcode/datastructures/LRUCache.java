...
public class LRUCache {
    ...
    public static void main(String[] args) {
        /*
        com.chin.leetcode.datastructures.LRUCache cache = new com.chin.leetcode.datastructures.LRUCache(2);
        cache.put(1, 1);
        cache.put(2, 2);
        ...
        com.chin.leetcode.datastructures.LRUCache test2 = new com.chin.leetcode.datastructures.LRUCache(2);
        test2.put(2, 1);
        test2.put(2, 2);
        ...
        com.chin.leetcode.datastructures.LRUCache test3 = new com.chin.leetcode.datastructures.LRUCache(2);
        test3.put(2, 1);
        test3.put(1, 1);
        test3.put(2, 3);
        test3.put(4, 1);
